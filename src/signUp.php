    ...
    <div class="signUpFormContainer">
        ...
        <form id="myForm" method="post" action="../controller/php/signUpController.php" class="signUpForm">
            ...
            <label for="phoneId" class="signUpFormLabel">Téléphone</label><br>
                <input type="tel" value="<?php if(isset($phoneSave)){echo $phoneSave;}?>" name="phone" id="phoneId" class="signUpFormInput" placeholder="format attendu : 00 00 00 00 00" autocomplete="off" ><br><br>
