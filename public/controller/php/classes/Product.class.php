...
class Product
{
    ...
    private $imageId;
    private $image;
    private $secondaryImageId;
    private $secondaryImage;

    public function __construct($product_id, $name, $brand, $color, $material, $price, $stock, $average_rating, $description, $imageId, $imagePath, $secondaryImageId, $secondaryImagePath)
    {
        ...
        $this->secondaryImage = $secondaryImagePath;
    }
